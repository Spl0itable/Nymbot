...
class BotCommands {
  ...
  static List<BotCommand> local() => [
        ...
        BotCommand(name: 'gift', args: '[code]', group: 'local', hint: () => t('Gift an amount of your credits as a link, or redeem a gift code')),
        BotCommand(name: 'transfer', args: '[npub]', group: 'local', hint: () => t('Move your whole balance to another key')),
        ...
        BotCommand(name: 'git', args: '[add|list|use|writes on|off|none|all]', group: 'local', hint: () => t('Manage the repositories this chat can read')),
        ...
        BotCommand(name: 'memory', args: '', group: 'local', hint: () => t('Read what Nymbot remembers about you')),
        BotCommand(name: 'forget', args: '', group: 'local', hint: () => t('Throw away what Nymbot remembers')),
        ...
        BotCommand(name: 'folder', args: '[name]', group: 'local', hint: () => t('File this conversation in a folder')),
        ...
        BotCommand(name: 'export', args: '[md|txt|json]', group: 'local', hint: () => t('Export this conversation as Markdown, plain text or JSON')),
        ...
        BotCommand(name: 'shortcuts', args: '', group: 'local', hint: () => t('Keyboard shortcuts')),
  ...
  static List<BotCommand> remote() => [
        ...
        BotCommand(name: 'research', args: '<question>', group: 'charged', hint: () => t('Deep research with a Pro model, with sources')),
        BotCommand(name: 'summarize', args: '<text>', group: 'charged', hint: () => t('Summarize something')),
