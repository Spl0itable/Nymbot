...
class BrandMarks {
  ...
  static const Map<String, BrandMark> marks = {
    ...
    'google': BrandMark(
      0xFF4285F4,
      Rect.fromLTWH(0.307, 0, 23.386, 24),
      [
    ...
    'moonshotai': BrandMark(
      0xFF6D28D9,
      Rect.fromLTWH(3, 0, 20.77, 20),
      [
    ...
    'black-forest-labs': BrandMark(
      0xFF1F2937,
      Rect.fromLTWH(0, 2.5, 24, 18.183),
      [
    ...
    'pixverse': BrandMark(
      0xFFDB2777,
      Rect.fromLTWH(5, 0.001, 15.078, 23.999),
      [
    ...
    'lightricks': BrandMark(
      0xFF0891B2,
      Rect.fromLTWH(2, 0, 19.684, 24),
      [
    ...
    'nvidia': BrandMark(
      0xFF76B900,
      Rect.fromLTWH(2, 4.499, 22, 15.001),
      [
    ...
    'stabilityai': BrandMark(
      0xFF7C3AED,
      Rect.fromLTWH(1, 3, 22, 18),
      [
    ...
    'perplexity': BrandMark(
      0xFF20808D,
      Rect.fromLTWH(1.5, 0, 21, 24),
      [
  ...
  static final Map<String, List<ui.Path>> _cache = {};

  static BrandMark? of(String slug) => marks[slug.toLowerCase()];
  ...
  static List<ui.Path> geometry(String slug) {
    ...
    final built = [
      for (final d in marks[key]!.paths)
        SvgPath.parse(d)..fillType = ui.PathFillType.evenOdd,
    ];
    _cache[key] = built;
    return built;
  }
...
class BrandTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (mark == null) {
      final letters = slug.toLowerCase().replaceAll(RegExp(r'[^a-z]'), '');
